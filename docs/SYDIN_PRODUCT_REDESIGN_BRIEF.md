...
44. ◐ Conveniences: PO from low stock (Alerts), receiving from PO, invoice from customer page, inline create customer/depot. ☐ duplicate PO/sale, remember last depot/payment method.
