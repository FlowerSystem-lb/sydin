                ...
                <form onSubmit={handleSubmit}>
                  <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full rounded-2xl border border-white/10 bg-black/35 px-5 py-4 text-base text-white outline-none transition placeholder:text-slate-600 focus:border-sydin-blue/50 focus:bg-black/45 focus:shadow-[0_0_0_4px_rgba(37,99,235,0.2)]"
                        required
                      />
                    </div>
                  ...
                  <div className="mt-5">
                    ...
                    <textarea
                      ...
                      className="min-h-[150px] w-full resize-y rounded-2xl border border-white/10 bg-black/35 px-5 py-4 text-base text-white outline-none transition placeholder:text-slate-600 focus:border-sydin-blue/50 focus:bg-black/45 focus:shadow-[0_0_0_4px_rgba(37,99,235,0.2)]"
