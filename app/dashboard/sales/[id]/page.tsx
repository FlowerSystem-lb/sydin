 ...
 * One invoice.
 *
 * Read-only for now, plus deleting a draft. Issuing -- which takes the goods out
 * of stock through the existing movement path -- is the next step, and it is
 * deliberately not a button that half works: an invoice that says "issued" while
 * stock never moved would be worse than one that cannot be issued yet.
 */
        ...
        <div className="mt-4 grid gap-4">
          ...
          {order.status === "draft" && (
            <p className="rounded-xl border border-theme bg-theme-inset px-4 py-3 text-xs text-theme-muted">
              This is a draft. Nothing has left stock and nobody has been billed.
              Issuing an invoice — which takes the goods out of stock — is coming
              next.
            </p>
          )}
