  ...
  return (
    ...
    >
      <div className="flex flex-col items-start gap-4 sm:flex-row">
        <span className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl border border-cyan-200/25 bg-sky-400/15 text-cyan-100 shadow-[0_14px_36px_rgba(14,165,233,0.16)]">
          <LockIcon />
        </span>
        <div className="min-w-0">
          ...
          <p className="mt-2 text-sm leading-6 text-slate-400">{benefit}</p>
...
export function UpgradeDialog({
  ...
  return (
    <div
      className="fixed inset-0 z-[80] flex items-center justify-center overflow-y-auto bg-[#020617]/85 p-4 backdrop-blur-xl"
      onClick={onClose}
    >
      <div
        role="dialog"
      ...
      >
        <div className="flex items-start justify-between gap-4">
          <div className="flex items-center gap-3">
            <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl border border-cyan-200/25 bg-sky-400/15 text-cyan-100">
          ...
          <button
            type="button"
            onClick={onClose}
            className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-white/10 bg-white/[0.05] text-slate-400 transition hover:bg-white/[0.1] hover:text-white"
        ...
        <div className="mt-5 grid grid-cols-1 gap-3 sm:grid-cols-2">
          <div className="rounded-2xl border border-white/10 bg-black/25 p-4">
            ...
            <p className="mt-2 font-black text-white">{prompt.currentPlan}</p>
          </div>
          <div className="rounded-2xl border border-sky-300/20 bg-sky-400/10 p-4">
            ...
            <p className="mt-2 font-black text-white">{prompt.requiredPlan}</p>
          </div>
        </div>
        <UpgradeActions
